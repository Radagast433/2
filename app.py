...
while True:
    ...
    img = imutils.resize(img, width = 900, height = 700)
    ...
    for i in indices:
        ...
        try:
            ...
            cv2.putText(img,classNames[int(classIds[i]) - 1].upper(),(int(box[0])+10,int(box[1])+31), cv2.FONT_HERSHEY_COMPLEX,0.5,(0,255,0),1)
